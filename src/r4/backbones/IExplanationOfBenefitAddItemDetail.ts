...
import { IExplanationOfBenefitAddItemSubDetail } from './IExplanationOfBenefitAddItemSubDetail';
import { IExplanationOfBenefitAdjudication } from './IExplanationOfBenefitAdjudication';

/**
 * @name IExplanationOfBenefitAddItemDetail
 * @description This resource provides: the claim details; adjudication details from the processing of a Claim; and optionally account balance information, for informing the subscriber of the benefits provided.
 * @see <a href="https://hl7.org/fhir/R4/explanationofbenefit-definitions.html#ExplanationOfBenefit.addItem.detail">ExplanationOfBenefitAddItemDetail</a>
 * @version R4
...
export interface IExplanationOfBenefitAddItemDetail extends IBackboneElement {
   ...
   */
  subDetail?: IExplanationOfBenefitAddItemSubDetail[];
}
