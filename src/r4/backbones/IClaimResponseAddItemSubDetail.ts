...
/**
 * @name IClaimResponseAddItemSubDetail
 * @description This resource provides the adjudication details from the processing of a Claim resource.
 * @see <a href="https://hl7.org/fhir/R4/claimresponse-definitions.html#ClaimResponse.addItem.detail.subDetail">ClaimResponseAddItemSubDetail</a>
 * @version R4
 * @extends {IBackboneElement}
 * @author Claudia Alarcón Lazo
 */
export interface IClaimResponseAddItemSubDetail extends IBackboneElement {
  /**
